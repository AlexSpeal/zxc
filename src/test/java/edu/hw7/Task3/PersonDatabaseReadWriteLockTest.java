...
class PersonDatabaseReadWriteLockTest {
    ...
    private final Thread thread1 = new Thread(() -> {
        PERSON_DATABASE.add(new Person(0, "Anatoliy", "Mitin", "11222"));
        PERSON_DATABASE.add(new Person(1, "Pavel", "Barkoff", "45633"));
    ...
    private final Thread thread2 = new Thread(() -> {
        ...
        PERSON_DATABASE.add(new Person(4, "Alexander", "Gonnyih", "12352"));
        PERSON_DATABASE.add(new Person(5, "V", null, "44444"));
    });
