...
public class LogsParserTest {
    ...
    void successRead() {
        ...
        assertThat(logString.httpUser()).isEqualTo(
            "Mozilla/5.0 (Macintosh; PPC Mac OS X 10_7_8) AppleWebKit/5330 (KHTML, like Gecko) Chrome/37.0.880.0 Mobile Safari/5330");
